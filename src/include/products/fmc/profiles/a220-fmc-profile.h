#ifndef A220_FMC_PROFILE_H
#define A220_FMC_PROFILE_H

#include "fmc-aircraft-profile.h"

class A220FMCProfile : public FMCAircraftProfile {
    public:
        A220FMCProfile(ProductFMC *product);
